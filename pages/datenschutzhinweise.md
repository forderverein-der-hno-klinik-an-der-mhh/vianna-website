...
Im Folgenden informiert der Verantwortliche, anschließend VIANNA genannt, über die Verarbeitung von personenbezogenen Daten nach Maßgabe der Anforderungen aus Art. 12–14 DSGVO.

## Allgemeine Informationen

Die nachfolgenden allgemeinen Informationen beziehen sich auf alle Verarbeitungen im Rahmen der Webangebote des VIANNA.

### Verantwortlicher für die Verarbeitung

Klinik und Poliklinik für Hals-, Nasen- und Ohrenheilkunde und Deutsches HörZentrum der Medizinischen Hochschule Hannover (MHH), OE 6500  
Klinikdirektorin: Prof. Dr. med. Anke Leichtle  
Anschrift: Carl-Neuberg-Str. 1, 30625 Hannover, Deutschland

Telefon: 0511/532-6565  
Telefax: 0511/532-5558  
E-Mail: [hno-presse@mh-hannover.de](mailto:hno-presse@mh-hannover.de)
...
E-Mail: [datenschutz@mh-hannover.de](mailto:datenschutz@mh-hannover.de)  
Internet: [www.mhh.de/datenschutz](https://www.mhh.de/datenschutz)
...
Bei der Nutzung der Webseiten des Webangebots des VIANNA werden von den Nutzern Daten verarbeitet. Da dies potentiell von jedem Nutzer ohne eine explizite Eingabeaufforderung erfolgt, werden diese möglichen Verarbeitungen im Folgenden im Zusammenhang dargestellt. Zu diesen Verarbeitungen im Rahmen des Webangebots des VIANNA werden die folgenden Informationen gemäß Art. 12–14 DSGVO gegeben.

### Zugriffsdaten/Server-Logfiles

Die Website des VIANNA wird über den Webspace-Provider „Netlify“ der Netlify, Inc., 2325 3rd Street, Suite 215, San Francisco, 94107 CA gehostet. Ausgeliefert wird diese Website dabei über das Cluster „EU (Frankfurt) – eu-central-1“. Dieser erstellt Server-Logfiles.

Bitte beachten Sie die [Datenschutzerklärung von Netlify](https://www.netlify.com/gdpr/).

Erhoben wird die IP-Adresse des Besuchenden, die 30 Tage lang vom o. g. Dienstleister gespeichert und daraufhin unwiederbringlich gelöscht wird.

### Webanalyse

Wir setzen die Matomo-Webanalyse-Software ein. Um mehr über die Nutzung zu erfahren, [klicken Sie bitte hier](https://matomo.mhh-hno.de/index.php?module=CoreAdminHome&action=optOut&language=de).
...
Die Verarbeitung der Daten erfolgt jeweils aufgrund des berechtigten Interesses des VIANNA gemäß Art. 6 Abs. 1 f) DSGVO, wobei das berechtigte Interesse des VIANNA in der Erhöhung der Benutzerfreundlichkeit beziehungsweise in der Ermöglichung der Verbesserung des Webangebots liegt.

Sie als Nutzer können auf den Einsatz der Cookies Einfluss nehmen. Die meisten Browser verfügen über eine Option, mit der das Speichern von Cookies eingeschränkt oder komplett verhindert wird. Zudem lassen sich bereits gespeicherte Cookies im Browser anzeigen und löschen. Werden auf einem Gerät mehrere Browser benutzt (z. B. Chrome und Firefox), müssen die jeweiligen Einstellungen in jedem Browser vorgenommen werden. Es wird darauf hingewiesen, dass die Nutzung und insbesondere der Nutzungskomfort des Webangebots ohne Cookies eingeschränkt sein kann.
